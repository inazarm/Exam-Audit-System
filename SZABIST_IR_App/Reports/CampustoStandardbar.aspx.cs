...
{
    public partial class CampustoStandardbar : System.Web.UI.Page
    {
        ...
        public void GetReport(int SemesterId, int SemesterYear)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath(@"~/Reports/CampustoStandardbar.rdlc");
            DataTable dt = new DataTable();
            Util u = new Util();
            string Query = "select * from  Vu_CampustoStandard where semster = "+SemesterId+ " and searchyear = " + SemesterYear + "";
            dt = u.RunAQry(Query);
            ...
            ReportParameter[] param = new ReportParameter[] {
                new ReportParameter("Semester",SemesterName, false),
